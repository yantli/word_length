...
def read_in_file(file):
    ...
    for row in rows:
        ...
        save_prob('/Users/yanting/Desktop/word_length/probs/prob_lineclue10.csv', new_row)
...
if __name__ == "__main__":
    read_in_file('/Users/yanting/Desktop/word_length/probs/prob_line_clue10.csv')